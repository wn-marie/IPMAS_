Dataset: KEGE8AFL
Displacement Restriction: admin2 (sub-counties)
...
Note: Cluster 778 is outside the Kenya 2022 DHS survey boundaries available on The DHS Program's Spatial Data Repository 
(https://spatialdata.dhsprogram.com/boundaries). This cluster was surveyed outside these boundaries. This cluster was 
displaced to fall within the maximum displacement distances detailed above.
